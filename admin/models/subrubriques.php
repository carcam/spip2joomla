 ...
 */
class spip2joomlasModelsubrubriques extends JModel
{
	var $_params;	
	var $_data;
	var $_joomla_id;
...
function __construct()
{
	...
	function getData()
   {
		...
		if ( !$db->loadObjectList() ) {
            JError::raiseNotice(500, 'SPIP Table connection Warning: ' . $db->toString() . '<br />No data founds for this feature or check your SPIP table Prefix in Spip2Joomla parameters !' );
            return false;
      }
