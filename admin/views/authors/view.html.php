 ...
 * @subpackage Components
 */
class spip2joomlasViewauthors extends JView
{
    /**
    ...
    function display($tpl = null)
    {
      ...
      JToolBarHelper::title( JText::_( 'Spip 2 Joomla User Manager' ), 'import-auteurs.png' );
      JToolBarHelper::custom('importAuthors','import-auteurs.png','import-auteurs.png',JText::_('Import Authors'),false,false);

      JSubMenuHelper::addEntry(JText::_('CONTROL PANEL'), 'index2.php?option=com_spip2joomla');
		JSubMenuHelper::addEntry(JText::_('SPIP2JOOMLA_AUTEURS'), 'index2.php?option=com_spip2joomla&view=authors', true);
