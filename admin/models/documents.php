 ...
 */
class spip2joomlasModeldocuments extends JModel
{
	var $_params;
	var $_id;
    /**
   ...
   */
    ...
    function getData()
    {
		$params = &JComponentHelper::getParams( 'com_spip2joomla' );
 		...
 		$spipDirectory= '..'. DS . $spipDirectory . DS. 'IMG' . DS . 'gif';
 		$filter='.';
 		$recurse=false;
 		$fullpath=true;
 		
 		$this->_data= JFolder::files($spipDirectory,$filter,$recurse,$fullpath);
